...
def main():
    ...
    parser.add_argument(
        "--openjev-execution",
        choices=["current", "shared-prefix"],
        default="current",
        help="Shared-prefix prefills instructions + context once, then batches candidate suffixes",
    )
    ...
    protocol = {
        ...
        "openjev": {
            ...
            "verify_parent_cache_during_warmup": args.openjev_execution == "shared-prefix",
            "optimize_head": True,
            "decoder_layers": 24,
        },
        ...
        "timing": (
            ...
            "exclude load, shared game preview, logging, and rendering"
        ),
        "limitations": [
