...
| Matched-board median latency | 136.6 ms | 171.5 ms |
| Matched-board p95 latency | 148.6 ms | 180.4 ms |
...
The permanent 74-token prefix took 68.6 ms to initialize once after model loading. This is excluded from request timings; see [initialization.json](initialization.json).
