...
sys.path[:0] = [str(ROOT / "src"), str(ROOT / "examples/game_2048")]
...
class Scorers:
    def __init__(self):
        ...
        self.openjev = DecisionEngine.from_pretrained(
            MODEL,
            revision=REVISION,
            backend="mlx",
            batch_size=4,
...
def main():
    ...
    protocol = {
        ...
        "openjev": {"batch_size": 4, "score_mode": "full", "cache_strategy": "single"},
